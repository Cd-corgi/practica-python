...
from .functions import saveTercero,getTerceros,getTercero
...
def verificarStatus(request):
    ...
    if request.method == "GET":
        ...
        usuario = "SARPSOFT29122022"
        password = "1a747a245fbcf9eeeb3d0c843e767e4fa304b321d9955b7c0d08460c82eb4750"
        transaccionID = "1rhecww9fe4mxord6v7qoio2dhga7yls"
...
def guardarTercero(request):
    ...
    if request.method == "POST":
        ...
        descuentoC   = request.data['descuentoCliente']
        descuentoP   = request.data['descuentoProveedor']
        RTFCliente   = request.data['retencionCliente']
        RTFproveedor = request.data['retencionProveedor']
        tercero = saveTercero(True,tercero,descuentoC,descuentoP,RTFCliente,RTFproveedor)
    ...
    if request.method == "PUT":
        ...
        RTFCliente   = []
        RTFproveedor = []
        if request.data['descuentoCliente']:
            descuentoC   = request.data['descuentoCliente']
        if request.data['descuentoProveedor']:
            descuentoP   = request.data['descuentoProveedor']
        if request.data['retencionCliente']:
            RTFCliente   = request.data['retencionCliente']
        if request.data['retencionProveedor']:
            RTFproveedor   = request.data['retencionProveedor']
    
        
        tercero = saveTercero(False,tercero,descuentoC,descuentoP,RTFCliente,RTFproveedor)
        return Response(TercerosCreateSerializer(tercero).data)
