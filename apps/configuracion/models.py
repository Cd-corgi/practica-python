...
class numeracion(models.Model):
    ...
    resolucion        = models.CharField('Resolución:', max_length=500)
    empresa           = models.ForeignKey(Empresa, related_name='numeracion_empresa', on_delete=models.PROTECT)
    fecha_vencimiento = models.DateField('fecha vencimiento:', auto_now=False, auto_now_add=False)
...
class Terceros(models.Model):
    ...
    correoFacturas              = models.EmailField('Correo Contacto', max_length=254,blank=True, null=True)
    ...
    regimen                     = models.CharField('Regimen:',max_length=50)
    obligaciones                = models.CharField('Obligaciones', max_length=50, default="R-99-PN")
